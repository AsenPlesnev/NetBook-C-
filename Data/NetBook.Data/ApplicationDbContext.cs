namespace NetBook.Data
{
    ...
    public class ApplicationDbContext : IdentityDbContext<NetBookUser, NetBookRole, string>
    {
        ...
        public new DbSet<NetBookUser> Users { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Absence>()
                .HasOne(absence => absence.Student)
                .WithMany(student => student.Absences);

            builder.Entity<Remark>()
                .HasOne(remark => remark.Student)
                .WithMany(student => student.Remarks);

            builder.Entity<NetBookUser>()
                .HasOne(u => u.Class)
