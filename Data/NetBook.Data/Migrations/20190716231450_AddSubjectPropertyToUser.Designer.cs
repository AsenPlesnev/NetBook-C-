...
namespace NetBook.Data.Migrations
{
    ...
    [Migration("20190716231450_AddSubjectPropertyToUser")]
    partial class AddSubjectPropertyToUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetBook.Data.Models.Student", b =>
                {
                    b.HasOne("NetBook.Data.Models.Subject")
                        .WithMany("Students")
                        .HasForeignKey("SubjectId");
                });
            ...
            modelBuilder.Entity("NetBook.Data.Models.Subject", b =>
                {
                    b.HasOne("NetBook.Data.Models.Student")
                        .WithMany("Subjects")
                        .HasForeignKey("StudentId");
                });
